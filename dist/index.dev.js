...
console.log("Script is working properly"); // Get the modal
...
var menuList = ['Rice & Pasta Dishes', 'Side Dishes', 'Soups & Swallows', 'Proteins', 'Drinks']; // Get the <span> element that closes the modal

var span = document.getElementsByClassName("close-menu-group")[0]; // When the user clicks on the button, open the modal
...
form.addEventListener('submit', function (e) {
  ...
  console.log(newMenuGroup); // Storing all formed New Menu Group Objects 

  Groups = [];
  Groups.push(newMenuGroup);
  window.sessionStorage.setItem('Groups', JSON.stringify(Groups)); // Clearing all Arrays
  ...
  groupList.length = 0; // Clearing all Objects

  newMenuGroup = (_readOnlyError("newMenuGroup"), {});
  lists = {};
